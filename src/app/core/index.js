...
import { msDatepickerFixConfigProvider, msDatepickerFix } from './directives/ms-datepicker-fix/ms-datepicker-fix.directive';
...
import { msMasonryController, msMasonry, msMasonryItem } from './directives/ms-masonry/ms-masonry.directive';
import { msMaterialColorPickerController, msMaterialColorPicker } from './directives/ms-material-color-picker/ms-material-color-picker.directive';
import { msNavFoldService, msNavIsFoldedDirective, MsNavController, msNavDirective, msNavTitleDirective, msNavButtonDirective, msNavToggleDirective } from './directives/ms-nav/ms-nav.directive';
import {
...
import { MsSearchBarController, msSearchBarDirective } from './directives/ms-search-bar/ms-search-bar.directive';
import { MsShortcutsController, msShortcutsDirective } from './directives/ms-shortcuts/ms-shortcuts.directive';
...
import { MsStepperController, msHorizontalStepperDirective, msHorizontalStepperStepDirective, msVerticalStepperDirective, msVerticalStepperStepDirective } from './directives/ms-stepper/ms-stepper.directive';
import { MsTimelineController, msTimelineDirective, msTimelineItemDirective } from './directives/ms-timeline/ms-timeline';
import { MsWidgetController, msWidgetDirective, msWidgetFrontDirective, msWidgetBackDirective } from './directives/ms-widget/ms-widget.directive';

// filters
import altDate from './filters/altDate.filter';
import { toTrustedFilter, htmlToPlainTextFilter, nospaceFilter, humanizeDocFilter } from './filters/basic.filter';
...
// theme-options
import { MsThemeOptionsController, msThemeOptions } from './theme-options/theme-options.directive';
